...
On Debian and derived distributions, build a package for system-wide
installation with:
...
The package installs executables below `/usr/bin`, menus and translations below
`/usr/share`, and configuration in `/etc/atmiral/atmiral.conf`.
